...
study_order <- c('Jiang (2022)', 'Chen (2019)', 'Starr (2022)', 'Gokhale (2023)', 'Eton (2022)',
                 'Stewart (2020)', 'Khanna (2022)',
                 'Brown (2019)', 'Aggarwal (2024)', 'Blitzer (2021)', 'Kaufmann (2023)', 'Lee (2019)')
...
bias <- bias +
  labs(title = 'ROBINS-I Tool Analysis', x = 'Bias Domain', y = NULL) + scale_y_discrete(position = "right")
