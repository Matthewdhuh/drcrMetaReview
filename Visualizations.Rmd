...
study_order <- c('Jiang (2022)', 'Chen (2019)', 'Gokhale (2023)', 'Eton (2022)',
                 'Stewart (2020)',
...
rates <- ggplot(drcrrates, aes(x = Rate.ratio, y = Paper, color = Type)) +
  ...
  scale_color_manual(values = c('red','#FFDC36', '#00D811'))
...
\begin{minipage}[t]{0.5\textwidth}
  \begin{flushleft}
    ...
    \small
      {\textbf{Lee:} Case-control (selection bias)} \\
      {\textbf{Kaufmann:} Case-control (selection bias)} \\
      {\textbf{Khanna:} Case-control (selection bias)} \\
      {\textbf{Blitzer:} Case-control (selection bias)} \\ 
      {\textbf{Aggarwal:} Case-control (selection bias)} \\
      {\textbf{Brown:} Case-control (selection bias)} \\
      {\textbf{Starr:} Case-control (selection bias)} \\
      {\textbf{Stewart:} Cross-sectional (no temporal information)} \\
      {\textbf{Eton:} Unclear methods on time-dependent analysis} \\
      {\textbf{Gokhale:} Young population (greater than 40 yr); short time frame for time-dependent analysis} \\
      {\textbf{Chen:} No time-dependent analysis} \\
      {\textbf{Jiang:} No time-dependent analysis} \\
  \end{flushleft}
\end{minipage}
