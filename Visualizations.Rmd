...
\begin{minipage}[t]{0.5\textwidth}
  \begin{flushleft}
    ...
    \small
      {Stewart: Cross-sectional} \\
      {Eton: Unclear methods on time-dependent analysis} \\
      {Gokhale: Young population, short time frame for time-dependent analysis}\\
      {Starr/Chen/Jiang: No time-dependent analysis}\\
  \end{flushleft}
\end{minipage}
\
